...
class DropshipPipeline:
    ...
    Set pipeline.log_fn = callable before calling run() to redirect all logs.
    """
    ...
    def __init__(
        ...
        self.log_fn = None  # set externally to redirect all P.* output
    ...
    def stage_rewrite(
        ...
        rewriter = ProductRewriter(self.acfg, log_fn=self.log_fn)
